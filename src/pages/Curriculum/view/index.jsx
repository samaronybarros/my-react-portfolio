		...
		return (
			<React.Fragment>
				...
				<MainDiv>
					...
					<MainParagraph>
						My name is Samarony Barros, but I am also known as Sam Barros. I'm a Senior Software Developer
						with 8+ years of experience, more specifically working with Java, PHP, JavaScript, C, and C++. I
						have created systems and customizations to help companies to optimize their process and I have
						created reports using Business Intelligence (BI) to support companies on making the best
						decision based on real data, not only empirical data.
					</MainParagraph>

					<MainParagraph>
						Nowadays, I'm responsible for designing, coding, unit testing and debugging application features
						as specified, applying a keen eye for detail and managing and prioritizing goals to deliver
						high-quality code. Besides, I also act as a Performance Mentor, coaching Developers to improve
						their software development skills and how to become more performative in creating queries on
						databases.
					</MainParagraph>
					...
					<MainParagraph>
						In my entrepreneurial career, I had the opportunity to manage projects and different kinds of
						teams, leading Developers, Consultants, and Designers. As an Entrepreneur, I turned myself into
						a multidisciplinary and committed professional with the ability to adapt to new situations.
					</MainParagraph>

					<MainParagraph>
						I'm proud to have created systems that have contributed to the success and growth of businesses.
						I'm passionate about personal and professional enhancement. In that way, I'm looking for a
						challenging opportunity focused on developing and improving the user experience and making a
						real impact on people's lives.
					</MainParagraph>

					<MainParagraph>
						If you think that I could add value to your network, add me as a contact. You can also find me
						at samarony.barros@gmail.com and http://sambarros.com
					</MainParagraph>
